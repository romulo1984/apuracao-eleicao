...
function getApiEndpoint (cargo, turno) {
  ...
  const codEleicao = (turno === 1) ? '000295' : '000296'
  ...
  <div class="row mt-5">
    <div class="col-md-12">
      ...
      <div class="mb-4" v-if="turno === 2">
        <img src="https://tribunaonline.com.br/secureproxy/?s3.amazonaws.com/static.tribunaonline.com.br/general-assets-apps/apuracao/presidente/bar-chart-preloader.176c94fd.svg" alt="Carregando..." width="25">
        <span class="text-black-50">atualizando em {{ updateTime }}</span>
        <div v-if="loading" class="d-inline-block ml-md-3">
          <img src="https://tribunaonline.com.br/secureproxy/?s3.amazonaws.com/static.tribunaonline.com.br/general-assets-apps/apuracao/regional/double-rings.5cf5e57c.svg" alt="Carregando..." width="25">
